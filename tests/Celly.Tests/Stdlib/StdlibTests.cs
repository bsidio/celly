...
public class GoDoubleFormatterTests
{
    ...
    [InlineData(1e23, "100000000000000000000000")]
    [InlineData(1.2345e25, "12345000000000000000000000")]
    [InlineData(1e-7, "0.0000001")]
    [InlineData(1.5e-9, "0.0000000015")]
    [InlineData(double.MaxValue, "")]
...
public class StdlibEvalTests
{
    ...
    [InlineData("string(1e23) == '100000000000000000000000'", true)]
